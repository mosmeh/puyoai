...
PuppetAI::PuppetAI(int argc, char* argv[], const string& name, const string& expertName) :
    PuppetAI(name)
{
    UNUSED_VARIABLE(argc);
    UNUSED_VARIABLE(argv);

    masterConnector_ = ServerConnector::create(1, expertName);
}

PuppetAI::PuppetAI(const string& name) :
    name_(name),
...
void PuppetAI::runLoop()
{
    ...
    while (true) {
        ...
        masterConnector_->send(frameRequest);
        masterConnector_->receive(&masterResponse_);
        connector_->send(masterResponse_);
...
void PuppetAI::gaze(int frameId, const CoreField&, const KumipuyoSeq&)
{
    UNUSED_VARIABLE(frameId);
}

void PuppetAI::gameWillBegin(const FrameRequest& frameRequest)
{
    me_.clear();
    enemy_.clear();
...
void PuppetAI::gameHasEnded(const FrameRequest& frameRequest)
{
    onGameHasEnded(frameRequest);
}

void PuppetAI::preDecisionRequestedForMe(const FrameRequest& frameRequest)
{
    // Do nothing.
    onPreDecisionRequestedForMe(frameRequest);
}

void PuppetAI::decisionRequestedForMe(const FrameRequest& frameRequest)
{
...
void PuppetAI::decisionRequestedForEnemy(const FrameRequest& frameRequest)
{
...
// static
void PuppetAI::decisionRequestedForCommon(PlayerState* p1, PlayerState* p2)
{
...
void PuppetAI::groundedForMe(const FrameRequest& frameRequest)
{
...
void PuppetAI::groundedForEnemy(const FrameRequest& frameRequest)
{
...
void PuppetAI::groundedForCommon(PlayerState* state, int frameId)
{
...
void PuppetAI::puyoErasedForMe(const FrameRequest& frameRequest)
{
...
void PuppetAI::puyoErasedForEnemy(const FrameRequest& frameRequest)
{
...
// static
void PuppetAI::puyoErasedForCommon(PlayerState* p1, PlayerState* p2, int frameId, const PlainField& provided)
{
    p1->currentChain += 1;
...
void PuppetAI::ojamaDroppedForMe(const FrameRequest& frameRequest)
{
    ojamaDroppedForCommon(&me_);
    onOjamaDroppedForMe(frameRequest);
}

void PuppetAI::ojamaDroppedForEnemy(const FrameRequest& frameRequest)
{
...
// static
void PuppetAI::ojamaDroppedForCommon(PlayerState* state)
{
    state->fixedOjama = std::max(state->fixedOjama - 30, 0);
    state->hasOjamaDropped = true;
}

void PuppetAI::next2AppearedForMe(const FrameRequest& frameRequest)
{
...
void PuppetAI::next2AppearedForEnemy(const FrameRequest& frameRequest)
{
    const KumipuyoSeq& kumipuyoSeq = frameRequest.enemyPlayerFrameRequest().kumipuyoSeq;
...
void PuppetAI::next2AppearedForCommon(PlayerState* state, const KumipuyoSeq& kumipuyoSeq)
{
    if (desynced_)
        return;
...
// static
bool PuppetAI::isFieldInconsistent(const PlainField& f, const PlainField& provided)
{
    for (int x = 1; x <= 6; ++x) {
        for (int y = 1; y <= 12; ++y) {
...
// static
CoreField PuppetAI::mergeField(const CoreField& cf, const PlainField& provided, bool ojamaDropped)
{
    CoreField result;
...
KumipuyoSeq PuppetAI::rememberedSequence(int indexFrom, const KumipuyoSeq& provided) const
{
    if (desynced_)
        return provided;
